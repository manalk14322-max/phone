(() => {
  ...
  function refreshRevealTargets() {
    const targets = document.querySelectorAll(
      ".hero-grid, .section, .category-card, .featured-category-card, .spotlight-card, .product-card, .trust-item, .newsletter-box, .repair-offer"
    );
    targets.forEach((el) => {
  ...
  function initPremiumAnimations() {
    ...
    if (window.ScrollTrigger) {
      gsapLib.from(".repair-offer, .category-tile", {
